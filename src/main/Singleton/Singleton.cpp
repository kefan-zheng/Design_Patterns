...
NationMedal::NationMedal(const NationMedal& m) {
    ...
    void MedalRanking::addCountry(string country, int g, int s, int c) {
		nationList.push_back(new NationMedal(country, g, s, c));
	}
    void MedalRanking::setCountryMedal(string country, int g, int s, int c) {
    ...
    void MedalRanking::sortMedal(int policy = PRI_GOLD)
    {
