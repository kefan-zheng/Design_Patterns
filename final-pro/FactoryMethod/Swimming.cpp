...
int fAthlete::getDis() const
{
    return distance;
}
std::string fAthlete::getName() const
{
    return name;
}
bool fAthlete::isFinal() const
{
    return distance == 200;
}
int fAthlete::getTime() const
{
    return time;
}
void Swimming::addAth(fAthlete ath)
{
